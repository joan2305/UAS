...
return [
        ...
        'between' => [
            'numeric' => 'Konten ini harus memiliki panjang di antara :min dan :max item.',
            'file' => 'Berkas ini harus berukuran di antara :min dan :max kilobyte.',
            'string' => 'Nilai ini harus bernilai di antara :min dan :max.',
            'array' => 'String ini harus memiliki panjang di antara :min dan :max karakter.',
        ],
